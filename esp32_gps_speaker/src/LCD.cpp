...
namespace LCD {
    ...
    String decode_msg(String Keywd, String Payload){
        if (Keywd == "Text_color"){ //sets text color
          if (Payload == "red"){
        ...
        if (Keywd == "Fill_color"){ //sets fill_color (also wipes screen) 
          if (Payload == "red"){
        ...
        if (Keywd == "Rotation") { //sets the screen rotation
          if (Payload == "0"){
            tft.setRotation(0);
            return "Success";
          }
        ...
        if (Keywd == "Cursor") { //change where text starts printing ((x, y) coords)
        ...
        if (Keywd == "Rect") { //print a rectangle (Top_left x, Top_left y, width, height, color)
